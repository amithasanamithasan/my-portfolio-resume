...
<div class="arlo_tm_wrapper_all">
        ...
        <div class="arlo_tm_leftpart_wrap">
            <div class="leftpart_inner">
                ...
                <div class="menu_list_wrap">
                    <ul class="anchor_nav">
                        <li><a href="#home"> <p class="btn btn-primary" >Home </a></li></p>
            <li><a href="#about"><p class ="btn btn-success mr-4">About</a></li></p>
            <li><a href="#services"><p class="btn btn-danger">Services"</a></li></p>
            <li><a href="#portfolio"><p class="btn btn-info">Portfolio</a></li></p>
            <li><a href="#contact"><p class="btn btn-info active">Contact Me</a></li></p>
                    </ul>
                </div>
                ...
                <div class="arlo_tm_section" id="home">
                    <div class="arlo_tm_hero_header_wrap">
                        <div class="arlo_tm_universal_box_wrap">
                         ...
                         <p>I'm a <span >Full Stack Web Developer </span></p>
                         <p>I'm a <span >Freelancer </span></p>
                                    </div>
                                </div>
                            </div>
                ...
                <img src="{{URL::to('fornted/img/about/550x640.jpg')}}" alt="550x640" />
                                    ...
                                    <div class="rightbox">
                                        ...
                                        <div class="buttons_wrap">
                                            <ul>
                                                <li>
                                                    <a href=https://storage.turbo360.co/amit-hasan-faysal-aeu5li/CV-Amit%20Hasan%20Faysal.pdf><span>Download CV</span></a>
                                                </li>
                                                <li class="anchor">
  ...
  <div class="arlo_tm_progress" data-value="40%" data-color="#FF0066">
                                                <span><span class="label">REACTJS - <span class="experience">1 years of experience</span></span><span class="number">40%</span></span>
                                                <div class="arlo_tm_bar_bg"><div class="arlo_tm_bar_wrap"><div class="arlo_tm_bar"></div></div></div>
                                            </div>

 <div class="arlo_tm_progress" data-value="70%" data-color="#FF0066">
                                                <span><span class="label">PHP Languages - <span class="experience">2 years of experience</span></span><span class="number">70%</span></span>
                                                <div class="arlo_tm_bar_bg"><div class="arlo_tm_bar_wrap"><div class="arlo_tm_bar"></div></div></div>
                                            </div>
                                            ...
                                            <div class="arlo_tm_progress" data-value="65" data-color="#FFE100">
                                                <span><span class="label">FRAMEWORK LARAVEL (BackEnd) - <span class="experience">2 years of experience</span></span><span class="number">65%</span></span>
                                                <div class="arlo_tm_bar_bg"><div class="arlo_tm_bar_wrap"><div class="arlo_tm_bar"></div></div></div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="list_wrap">
                                <ul>
                                    <li>
                                        <div class="inner">
                                            <div class="icon">
                                                <img class="svg" src="img/svg/camera-diaphragm.svg" alt="Front-end Web Devoloper" />
                                            </div>
                                            <div >
                                                <h3 class="text-warning">Web Design</h3>
                                            </div>
                                            <div class="text">
                                                <p class="text-primary">Web designers use our creative and software engineering/programming skills to design, build and improve websites. we understand user experience and are able to build websites that are easy to understand, navigate, and use, and adhere to design standards and specifications. we are sometimes known as a front-end developer</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="inner">
                                            <div class="icon">
                                                <img class="svg" src="img/svg/new-tab.svg" alt="Back-end Web Developer " />
                                            </div>
                                            <div >
                                                <h3 class="text-warning">Web Devolopment</h3>
                                            </div>
                                            <div class="text">
                                                <p class="text-primary">A back-end web developer is responsible for server-side web application logic and integration of the work front-end web developers do. Back-end developers usually write web services and APIs used by front-end developers and mobile application developers.

Writing a good job description and a job ad for a back-end developer requires proper separation of concerns. Posting a generic web developer description in your job ad, when you are looking for an advanced back-end web developer, will bring numerous applications from people who are specialized in building front-end user interface, or web designers who have absolutely no knowledge about programming.</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="inner">
                                            <div class="icon">
                                                <img class="svg" src="img/svg/layers.svg" alt="Freelancer" />
                                            </div>
                                            <div >
                                                <h3 class="text-warning">Freelancer</h3>
                                            </div>
                                            <div class="text">
                                                <p class="text-primary">i am a freelancer in upwork .i have many gigs likes, web Design,
                                                frontend, Shopify,Amazon Web services,Walmart,i recenty work in shopify web services </p>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="inner">
                                            <div class="icon">
                                                <img class="svg" src="img/svg/share.svg" alt="Digital marketing" />
                                            </div>
                                            <div >
                                                <h3 class="text-warning">Social Media</h3>
                                            </div>
                                            <div class="text">
                                                <p class="text-primary">i am working with some brands on social media like kids clothes ,kids toys also I sell home made Mango Pickles,Jalpei Pickels,Big Pickels Online from my facebook Pages </p>
                                            </div>
                                        </div>
                                    </li>
